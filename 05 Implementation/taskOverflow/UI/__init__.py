...
class mainUI():
	...
	def extractData(self):
		...
		duration=int(self.UnfixedWidget[-1].durationbuttonhh.text[0]+self.UnfixedWidget[-1].durationbuttonhh.text[2])*100+int(self.UnfixedWidget[-1].durationbuttonmm.text[0]+self.UnfixedWidget[-1].durationbuttonmm.text[2])
		ttype=0

		if 	self.UnfixedWidget[-1].fixrbut.type=="flexible":
			ttype=1
			lowerbound=int(self.UnfixedWidget[-1].lowerboundhh.text[0]+self.UnfixedWidget[-1].lowerboundhh.text[2])*100+int(self.UnfixedWidget[-1].lowerboundmm.text[0]+self.UnfixedWidget[-1].lowerboundmm.text[2])
			upperbound=int(self.UnfixedWidget[-1].upperboundhh.text[0]+self.UnfixedWidget[-1].upperboundhh.text[2])*100+int(self.UnfixedWidget[-1].upperboundmm.text[0]+self.UnfixedWidget[-1].upperboundmm.text[2])
			priority=int(self.UnfixedWidget[-1].priority.text[0]+self.UnfixedWidget[-1].priority.text[2])
			partition=self.UnfixedWidget[-1].partition.value
			print "task:\t",taskname,"\tduration:\t",duration,"\ttype:\t",ttype,"\tlowerbound\t",lowerbound,"\tupperbound",upperbound,"\tpriority\t",priority,"\tpartition\t",partition
			return 
	
		mustart=int(self.UnfixedWidget[-1].mustarthh.text[0]+self.UnfixedWidget[-1].mustarthh.text[2])*100+int(self.UnfixedWidget[-1].mustartmm.text[0]+self.UnfixedWidget[-1].mustartmm.text[2])
		print "task:\t",taskname,"\tduration:\t",duration,"\ttype:\t",ttype,"\tmustart\t",mustart
		return 
